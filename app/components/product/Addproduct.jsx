...
function Addproduct({ categories }) {
  ...
  function saveData(e) {
    ...
    //      add productImages inside product
  ...
  return (
    <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
      <div
        ...
        className='border-b border-stroke py-4 px-6.5 dark:border-strokedark flex justify-between align-center'
      >
        <h3 className='font-medium text-black dark:text-white'>
          Add A Product
        </h3>
        <h3
          className='bg-white dark:bg-boxdark cursor-pointer text-2xl'
          onClick={() => setShowProduct(!showProduct)}
        >
          {showProduct ? "-" : "+"}
        </h3>
          ...
          <div className='p-6.5'>
            ...
            <div className='mb-4.5 w-full '>
              ...
              <input
                ...
                className='w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary'
              />
              <button onClick={(e) => uploadToIMGBB(e)}>Upload</button>
            </div>
            {!!productImage && (
              <img className='mb-4.5 h-32' src={productImage} alt='' />
            )}
            ...
            <div className='mb-4.5 w-full  '>
              ...
              <div className='flex gap-3 mb-4.5'>
                ...
                <button
                  ...
                  onClick={(e) => productImageschange(e)}
                >
                  Add
                </button>
              </div>
                ...
                {productImages.length > 0 &&
                  productImages.map((data, index) => {
                    return (
                      <img
                        key={index}
                        onDoubleClick={() => deleteImage(data)}
